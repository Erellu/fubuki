...
#
# Will be defined: WAYLAND_CLIENT_FOUND WAYLAND_CLIENT_INCLUDE_DIR
...
find_library(
  ...
  PATHS ${PKG_WAYLAND_CLIENT_LIBRARY_DIRS})
set(wayland_client_FOUND TRUE)

add_library(wayland::client SHARED IMPORTED GLOBAL)
set_target_properties(
  wayland::client
  PROPERTIES IMPORTED_LOCATION "${wayland_client_LIBRARIES}"
             INTERFACE_INCLUDE_DIRECTORIES "${PKG_WAYLAND_CLIENT_LIBRARY_DIRS}"
             IMPORTED_LINK_INTERFACE_LANGUAGES "C")

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
  wayland_client DEFAULT_MSG wayland_client_INCLUDE_DIR
  wayland_client_LIBRARIES)
