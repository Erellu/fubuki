...
| `win32::begin_profile`               | Free function        | Profiling                 | `win32` implementation of `fubuki::io::begin_profile.`                                                     | N.A.                                                                                                                                          |     |
| `win32::end_profile`                 | Free function        | Profiling                 | `win32` implementation of `fubuki::io::end_profile.`                                                       | N.A.                                                                                                                                          |     |
| `profile_data::win32`                | Type alias, `struct` | Profiling                 | Timestamp indicating when the profiling began and the rate of performance counters on the current machine. | N.A.                                                                                                                                          |     |
...
| Name                                     | Type                 | Category            | Description                                                                                                      | Notes                                                           |     |
| ---------------------------------------- | -------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | --- |
| `linux_bsd::begin_profile`               | Free function        | Profiling           | `linux_bsd` implementation of `fubuki::io::begin_profile.`                                                       | N.A.                                                            |     |
| `linux_bsd::display`                     | `class`              | Display             | Interface to the various display connections (`wayland::display`, `xlib::display`, ...).                         | N.A.                                                            |     |
| `linux_bsd::end_profile`                 | Free function        | Profiling           | `linux_bsd` implementation of `fubuki::io::end_profile.`                                                         | N.A.                                                            |     |
...
| `profile_data::linux_bsd`                | Type alias, `struct` | Profiling           | Timestamp indicating when the profiling began.                                                                   | N.A.                                                            |     |
